...
const Dropdown = {
    ...
    componentWillMount() {
        ...
        console.warn('FocusComponents 2.2.0: this component is deprecated, please use focus-components-updated/components/dropdown or focus-components-updated/components/icon-dropdown instead');
