...
import connect from 'focus-components-updated/behaviours/store/connect';
...
## Exemple
[Exemple de advanced-search](https://github.com/KleeGroup/focus-components-updated/blob/master/page/search/advanced-search/example/index.html)
## Test
todo
## Démo
[Démo de advanced-search](http://kleegroup.github.io/focus-components-updated/page/search/advanced-search/example/)
